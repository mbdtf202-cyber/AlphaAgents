...
唯一机器可读真相源是 [contracts/alphaagents.contract.json](../contracts/alphaagents.contract.json)，人类解释见 [工程契约文档](./engineering-contract.md)。商业起步线、采购、证据状态和运营模板统一归档在 [商业运营文档](./operations.md)。
