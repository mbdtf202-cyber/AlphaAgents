...
const trialRoiRetrospective = {
  originalProcessHours: 8,
  buyerReviewHours: 1.2,
  cycleTimeSavedHours: 36,
  usableResultCount: 11,
  usableResultRate: "73%",
  acceptanceScore: 92,
  qaOpsHours: 0.7,
  supportHours: 0.2,
  runtimeCostMinor: 3800,
  providerPayoutMinor: 118800,
  refundCostMinor: 0,
  contributionMarginEstimate: "23%",
  repurchaseSignal: "repeat_trial_candidate",
  renewalSignal: "needs_validated_paid_order"
};

const revisionRoiRetrospective = {
  ...trialRoiRetrospective,
  cycleTimeSavedHours: 30,
  usableResultCount: 10,
  usableResultRate: "67%",
  acceptanceScore: 86,
  supportHours: 0.6,
  repurchaseSignal: "repeat_after_revision_sla_review"
};

const disputeRoiRetrospective = {
  ...trialRoiRetrospective,
  cycleTimeSavedHours: 18,
  usableResultCount: 7,
  usableResultRate: "47%",
  acceptanceScore: 72,
  supportHours: 1.6,
  providerPayoutMinor: 95040,
  refundCostMinor: 39600,
  contributionMarginEstimate: "8%",
  repurchaseSignal: "blocked_until_scope_and_quality_fix",
  renewalSignal: "not_ready"
};
...
const sellerProfiles = [
  {
    ...
    capacityAvailable: 3,
    confidentialityCommitment: "sandbox DPA ready",
    serviceCategories: ["social_media_operations", "intelligence_research"]
  },
  {
    ...
    payoutReadiness: "ready",
    capacityAvailable: 2,
    confidentialityCommitment: "manual review lane only",
    serviceCategories: ["legal_compliance_risk", "social_media_operations"]
  },
  {
    ...
    payoutReadiness: "ready",
    capacityAvailable: 1,
    confidentialityCommitment: "platform controlled program lane",
    serviceCategories: ["enterprise_operations", "custom_agent_app"]
  }
];

const categoryUnitEconomics = [
  {
    categoryId: "social_media_operations",
    scenario: "Standard learning",
    orders: 25,
    averageGmvMinor: 582000,
    takeRateBps: 2500,
    providerPayoutBps: 6000,
    qaOpsMinutes: 66,
    cacMinor: 52000,
    disputeCostBps: 400,
    contributionMarginBps: 1300
  },
  {
    categoryId: "intelligence_research",
    scenario: "Repeat buyer base",
    orders: 50,
    averageGmvMinor: 748000,
    takeRateBps: 2600,
    providerPayoutBps: 5800,
    qaOpsMinutes: 48,
    cacMinor: 26000,
    disputeCostBps: 300,
    contributionMarginBps: 2600
  },
  {
    categoryId: "custom_agent_app",
    scenario: "Enterprise credit",
    orders: 120,
    averageGmvMinor: 1050000,
    takeRateBps: 2800,
    providerPayoutBps: 5500,
    qaOpsMinutes: 33,
    cacMinor: 12000,
    disputeCostBps: 200,
...
const sampleOrders = [
  {
    packageId: "AA-SANDBOX-TRIAL-001",
    snapshot: trialSnapshot,
    review: trialReview,
    ledger: { ...trialLedger, ...sandboxFinanceProfile },
    roi: trialRoiRetrospective,
    run: trialRun,
    proposal: trialProposal,
    rfp: trialRfp,
    reputation: trialReputation,
    grants: trialGrants
  },
  {
    packageId: "AA-SANDBOX-REVISION-002",
    snapshot: revisionSnapshot,
    review: revisionReview,
    ledger: { ...revisionLedger, ...sandboxFinanceProfile },
    roi: revisionRoiRetrospective,
    run: revisionRun,
    proposal: revisionProposal,
    rfp: revisionRfp,
    reputation: revisionReputation,
    grants: revisionGrants
  },
  {
    packageId: "AA-SANDBOX-DISPUTE-003",
    snapshot: disputeSnapshot,
    review: disputeReview,
    ledger: { ...disputeLedger, ...sandboxFinanceProfile },
    roi: disputeRoiRetrospective,
    run: disputeRun,
    proposal: disputeProposal,
    rfp: disputeRfp,
    reputation: disputeReputation,
    grants: disputeGrants
  }
];
