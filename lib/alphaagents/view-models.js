...
import { listRuntimeListings, listRuntimeOrders, listRuntimeRfps } from "./runtime-queries.js";
...
export function getBuyerOrgSetupModel() {
  return {
    ...
    readiness: [
      { label: "Authority chain", status: "Pass" },
      { label: "Invoice readiness", status: "Pass" },
      { label: "Scope acknowledgement", status: "Pass" }
    ]
  };
}
